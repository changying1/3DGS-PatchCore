...
# python train_unet.py --mode rgb_g0123 --train_ids 1,2 --val_id 0 --seed 1 --epochs 50 --batch_size 2
# python train_unet.py --mode rgb_g0123 --train_ids 1,2 --val_id 0 --seed 2 --epochs 50 --batch_size 2
# python train_unet.py --mode rgb_g0123 --train_ids 1,2 --val_id 0 --seed 3 --epochs 50 --batch_size 2
